@php
    ...
    $hasLogo = $svg || $png;
@endphp
<div style="display:flex;align-items:center;gap:11px;padding:2px 0;line-height:1;">
    @if ($hasLogo)
    ...
    @endif
    <span style="font-weight:700;font-size:14px;color:#ECECF0;white-space:nowrap;letter-spacing:.02em;display:flex;align-items:center;">
