@php
    ...
    $hasLogo = $svg || $png;
@endphp
<div style="display:flex;align-items:flex-end;gap:12px;padding:15px 0 0;">
    @if ($hasLogo)
    ...
    @endif
    <span class="gqs-brand-text" style="font-weight:700;font-size:15px;color:#444;white-space:nowrap;letter-spacing:.03em;padding-top:13px;">
