<x-filament-panels::page>
    ...
    @if ($tab === 'upload')
        <div style="font-size:12px;color:var(--gqs-text-dim,#6A6A72);margin-bottom:14px;">Upload the weekly TrackWise NC export, then map the columns and import. NC links are built automatically.</div>
        ...
        <div style="margin:14px 0;display:flex;gap:8px;flex-wrap:wrap;align-items:center;">
            ...
            <span style="font-size:12px;color:var(--gqs-text-dim,#6A6A72);">{{ $this->catalogCount() }} NCs in catalog.</span>
        </div>
