                        ...
                        <tbody>
                            @foreach($incubating as $r)
                                <tr>
                                    ...
                                    <td><a href="{{ \App\Filament\Admin\Resources\QualificationResource::getUrl('view', ['record' => $r->id]) }}" style="color:var(--gqs-text,#1A1A1F);font-weight:600;text-decoration:underline;text-decoration-style:dotted;text-underline-offset:2px;" title="Open record in Active Runs">{{ $r->name }}</a></td>
                                    <td>
