...
class QualificationModal extends Component
{
    ...
    protected function build(): void
    {
        ...
        $this->detail = [
            ...
            'email' => $q->personnel?->email,
            'phone' => $q->personnel?->phone,
            'lims_username' => $q->personnel?->lims_username,
            'supervisor' => $q->personnel?->supervisor,
            'cycle_number' => (int) ($q->cycle_number ?? 1),
            'cycle_started' => $q->cycle_started_at?->gmp(),
            'type' => $q->sessionLabel(),
            'stage_val' => $stageVal,
