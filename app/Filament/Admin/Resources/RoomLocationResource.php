...
class RoomLocationResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'Room Location';
    public static function shouldRegisterNavigation(): bool { return false; }

    protected static function allowed(): bool
    {
        $u = Auth::user();
        return (bool) ($u && ($u->hasCapability(Capability::ManageScheduling) || $u->hasCapability(Capability::ManageClasses)));
    }
    ...
    public static function form(Schema $schema): Schema
    {
        return $schema->components([
            Section::make('Room Location')->columns(2)->schema([
    ...
    {
        return ['index' => Pages\ListRoomLocations::route('/')];
    }
}
