...
use App\Filament\Admin\Resources\SamplingSiteResource\Pages;
...
class SamplingSiteResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'Sampling Site';
    ...
    public static function form(Schema $schema): Schema
    {
        return $schema->components([
            Section::make('Sampling Site')->columns(2)->schema([
    ...
    {
        return ['index' => Pages\ListSamplingSites::route('/')];
    }
}
